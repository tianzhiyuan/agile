...
namespace CoolCaptcha
{
    ...
    public class SimpleCaptcha
    {
	    ...
	    private static readonly FontStyle[] fontStyles = new FontStyle[]
        ...
        static SimpleCaptcha()
        {
            ...
            using (PrivateFontCollection privateFonts = new PrivateFontCollection())
            {
				...
				{
					font.AvailableFontStyle = fontStyles.FirstOrDefault(fontStyle => font.FontFamily.IsStyleAvailable(fontStyle));
				}
                #endregion
            }
        }
        ...
        protected virtual void WriteText(Bitmap image, String text)
        {
            ...
            using (var foreBrush = new SolidBrush(this.ForeColor))
            {
				...
				var font = new Font(fontConfig.FontFamily, fontSize, fontConfig.AvailableFontStyle);
                ...
                for (int i = 0; i < length; i++)
                {
					...
					font = new Font(fontConfig.FontFamily, fontSize, fontConfig.AvailableFontStyle);
